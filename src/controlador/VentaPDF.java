...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            File file = new File(ruta + "/Downloads/" + nombreArchivoPDFVenta);
            ...
            String nombre = "Daniel Forero - Brayan Murcia";
            String telefono = "3123517559 - 3145029104";
            String direccion = "Chiquinquirá - Boyacá";
            String razon = "Software de Gestión para Tiendas";
