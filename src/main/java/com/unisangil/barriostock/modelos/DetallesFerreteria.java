package com.unisangil.barriostock.modelos;

public class DetallesFerreteria {
    private Integer id_detalle_ferreteria;
    private Integer id_producto;
    private String material;
    private String dimensiones;

    public DetallesFerreteria() {
    }

    public DetallesFerreteria(Integer id_detalle_ferreteria, Integer id_producto, String material, String dimensiones) {
